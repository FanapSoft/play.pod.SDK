    ...
    function Service(params) {
        ...
        var __self = this,
            ...
            __configData = {
                ...
                gcpn: "land.pod.play", // game center package name
                sba: "land.pod.play.actions.gameToGC",// send broadcast action
                ...
                sgltop : true,// send geolocشتation to object pool
        ...
        var __init = function () {
            ...
            __onReceiveNewMatchAction = function (matchData) {
                ...
                matchData.ownData = {
                    ...
                    imageUrl: __validateImageUrl(matchData.imageUrl)
                };
                ...
                matchData.opponentsData = [{
                    ...
                    imageUrl: __validateImageUrl(matchData.opponentData.imageUrl),
                    applicant: !matchData.applicant
                }];
                ...
                if (__games[data.gameId]) {
                    ...
                    if (hasMajorConflict) {
                        ...
                        if (typeof data.player1ImageUrl === "string") {
                            imageUrl = __validateImageUrl(data.player1ImageUrl);
                        }
            ...
            __createMatchDataFromDBData = function (matchDBData) {
                ...
                if (Array.isArray(matchDBData.opponentsData) && matchDBData.opponentsData.length > 0) {
                    ...
                    retData.opponentsData = [{
                        ...
                        imageUrl: __validateImageUrl(matchDBData.players.player2.imageUrl),
                ...
                if (matchDBData.ownData) {
                    ...
                    retData.ownData = {
                        ...
                        imageUrl: __validateImageUrl(matchDBData.players.player1.imageUrl),
            ...
            __asyncRequest = function (reqUrlName, data, callback, setting) {
                ...
                var paramData = "data=" + encodeURIComponent(JSON.stringify(asyncData));
                // paramData += "&peerId=" + peerId;
            ...
            __setDataToStorage = function (setting) {
                ...
                if (__userData.imageUrl) {
                    storageData.imageUrl = __validateImageUrl(__userData.imageUrl);
                }
            ...
            __setUserData = function (userData, setting) {
                ...
                if (typeof userData.imageUrl == "string") {
                    __userData.imageUrl = __validateImageUrl(userData.imageUrl);
                }
                        ...
                        if (result.HasError) {
                            ...
                            for (var i = 0; i < users.length; i++) {
                                ...
                                if (typeof user.ProfileImage === "string") {
                                    usr[userId].imageUrl = __validateImageUrl(user.ProfileImage);
                                }
                        ...
                        if (result.HasError) {
                            ...
                            for (var i = 0; i < users.length; i++) {
                                ...
                                usr[userId] = {
                                    ...
                                    imageUrl: __validateImageUrl(user.profileImage),
                                    id : userId
                                };
                        ...
                        if (Array.isArray(data.Table)) {
                            for (var i = 0; i < data.Table.length; i++) {
                                ...
                                var userData = {
                                    ...
                                    imageUrl: __validateImageUrl(uData.profileImage),
                                    scores: []
                                };
                        ...
                        for (var levelId in data) {
                            ...
                            for (var i = 1; i <= currentLevelMatchCount; i++) {
                                ...
                                if (validMatchNodeId) {
                                    ...
                                    matchDataObj.user1.imageUrl = __validateImageUrl(matchData.User1ImageUrl);

                                    matchDataObj.user2.id = matchData.UserId2;
                                    matchDataObj.user2.name = matchData.UserId2Name;
                                    matchDataObj.user2.isWinner = (typeof matchData.Winner == "number") ? matchData.Winner == matchData.UserId2 : undefined;
                                    matchDataObj.user2.image = matchData.User2Image;
                                    matchDataObj.user2.imageUrl = __validateImageUrl(matchData.User2ImageUrl);
            ...
            __reformatFriendshipRes = function (result) {
                ...
                var retData = {
                    ...
                    toUser: {
                        ...
                        name: toUser.name,
                        image: toUser.image,
                        imageUrl: __validateImageUrl(toUser.profileImage)
                    }
                };
                if(fromUser) {
                    retData.fromUser = {
                        ...
                        imageUrl: __validateImageUrl(fromUser.profileImage)
                    }
                }
                return retData;
            },
            ...
            __reformatCommentFormat = function (comment) {
                ...
                if(comment.user.profileImage) {
                    comment.user.imageUrl = __validateImageUrl(comment.user.profileImage);
            ...
            __validateImageUrl = function(url){
                ...
                function (result) {
                    ...
                    if (!result.HasError) {
                        ...
                        if (result.Result.profileImage) {
                            returnData.result.imageUrl = __validateImageUrl(result.Result.profileImage);
        ...
        *       });
                    ...
                    if (members) {
                        for (var i = 0; i < members.length; i++) {
                            ...
                            users[member.UserID] = {
                                ...
                                image: member.Image,
                                imageUrl: __validateImageUrl(member.ProfileImage)
                            };
                            ...
                            for (var j = 0; j < users.length; j++) {
                                ...
                                usersData[j] = {
                                    info: {
                                        ...
                                        imageUrl: __validateImageUrl(user.UserInfo.ProfileImage)
                                    }
                                };
        ...
        __self.initLogin = function (params, callback) {
            __loginAction({
                ...
                id: params.id,
                image: params.image,
                imageUrl: __validateImageUrl(params.imageUrl),
                    ...
                    if(result.Result) {
                        ...
                        for (var i = 0; i < topPlayers.length; i++) {
                            ...
                            if(playerInfo.profileImage) {
                                playerInfo.imageUrl = __validateImageUrl(playerInfo.profileImage);
                            }
                ...
                if (result.HasError) {
                    ...
                    if(result.Result) {
                        ...
                        for (var i = 0; i < friends.length; i++) {
                            ...
                            if(user) {
                                user.imageUrl = __validateImageUrl(user.image);
                                delete user.image;
                            }
        ...
        __self.refactorGameCenterGameObject = function(game){
            return __reformatGameObject(game);
        };

        __self.refactorLeagueCenterGameObject = function(league){
            return __reformatLeagueObject(league);
        };
